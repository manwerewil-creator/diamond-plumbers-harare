...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    quote: { text: 'Third element in two months until Diamon fitted surge protection. Six months on, no problems. Honest about the solar option without pushing it.', name: 'Rumbi C., Avondale' },
  ...
  },
  {
    ...
    time: 'Half-day',
    quote: { text: 'Two other plumbers just rodded it and left. Diamon put a camera down, found the actual problem, and it hasn’t come back since.', name: 'Farai N., Greendale' },
